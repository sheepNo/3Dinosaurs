...
from texture_test import Texture
...
MAX_VERTEX_BONES = 4
MAX_BONES = 128
def load_skinned(file, tex_file):
    ...
    for mesh in scene.meshes:
        ...
        mesh.skinned_mesh = SkinnedMesh([mesh.vertices, tex_uv, v_bone['id'], v_bone['weight']], Texture(texture), bone_nodes, bone_offsets, mesh.faces)
